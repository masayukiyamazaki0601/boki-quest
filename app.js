    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          '(借) 普通預金 210,000 / (貸) 定期預金 150,000 , 受取利息 60,000',
        ],
        correct: 0,
        explanation: {
          concept: '定期預金の満期',
      ...
      },
      {
        ...
        choices: [
          ...
          '(借) 旅費交通費 60,000 , 現金 30,000 / (貸) 仮払金 90,000',
        ],
        correct: 0,
        explanation: {
          concept: '仮払金の精算',
