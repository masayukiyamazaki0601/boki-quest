...
const roadmapLevels = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        text: '【一部振替と手数料】普通預金口座から当座預金口座へ 800円、定期預金口座へ 500円をそれぞれ預け入れた。その際、振込手数料 20円が普通預金口座から引き落とされた。',
        choices: [
          '(借) 当座預金 800 , 定期預金 500 , 支払手数料 20 / (貸) 普通預金 1,320',
          '(借) 当座預金 800 , 定期預金 500 / (貸) 普通預金 1,300',
          '(借) 当座預金 800 , 定期預金 520 / (貸) 普通預金 1,320',
          '(借) 現金 800 , 定期預金 500 , 支払手数料 20 / (貸) 普通預金 1,320',
        ],
        correct: 0,
        explanation: {
          concept: '資金振替と振込手数料',
          brilliantExplanation: '当座預金・定期預金（資産）の増加を借方に、振込手数料 20円は支払手数料（費用）として借方に、普通預金の減少 1,320円を貸方に記録します。'
        }
      },
      {
        text: '【電気料金の引落】店舗の電気料金 300円が普通預金口座から引き落とされた。',
        choices: [
          '(借) 水道光熱費 300 / (貸) 普通預金 300',
          '(借) 普通預金 300 / (貸) 水道光熱費 300',
          '(借) 水道光熱費 300 / (貸) 現金 300',
          '(借) 水道光熱費 300 / (貸) 普通預金 400',
        ],
        correct: 0,
        explanation: {
          concept: '公共料金の支払い',
      ...
      {
        text: '【普通預金の利息】普通預金口座に利息 200円が入金された。',
        choices: [
          '(借) 普通預金 200 / (貸) 受取利息 200',
          '(借) 受取利息 200 / (貸) 普通預金 200',
          '(借) 普通預金 200 / (貸) 受取手数料 200',
      ...
      {
        text: '【自社振出小切手の回収】売掛金 500円の回収のため小切手を受け取った。なお、この小切手は以前当社が振り出した小切手である。',
        choices: [
          '(借) 当座預金 500 / (貸) 売掛金 500',
          '(借) 現金 500 / (貸) 売掛金 500',
          '(借) 当座預金 500 / (貸) 普通預金 500',
          '(借) 現金 500 / (貸) 売掛金 400',
        ],
        correct: 0,
        explanation: {
      ...
      {
        text: '【小切手の預入】得意先C社に対する売掛金 600円の回収にあたり、同社振出しの小切手を受け取り、ただちに当座預金口座に預け入れた。',
        choices: [
          '(借) 当座預金 600 / (貸) 売掛金 600',
          '(借) 現金 600 / (貸) 売掛金 600',
          '(借) 当座預金 600 / (貸) 買掛金 600',
          '(借) 当座預金 700 / (貸) 売掛金 700',
        ],
        correct: 0,
        explanation: {
          concept: '他人振出小切手の預入',
      ...
      {
        text: '【定期預金の満期】定期預金が満期となり、元本 2,000円と利息 80円が普通預金口座に振り込まれた。',
        choices: [
          '(借) 普通預金 2,080 / (貸) 定期預金 2,000 , 受取利息 80',
          '(借) 普通預金 2,000 / (貸) 定期預金 2,000',
          '(借) 定期預金 2,000 , 受取利息 80 / (貸) 普通預金 2,080',
          '(借) 普通預金 2,080 / (貸) 定期預金 1,500 , 受取利息 580',
        ],
        correct: 0,
        explanation: {
          concept: '定期預金の満期',
          brilliantExplanation: '元本 2,000円は定期預金（資産の減少）を貸方に、利息 80円は受取利息（収益）として貸方に記録します。'
        }
      },
      {
        text: '【家賃の引落】事務所の今月分家賃 500円が普通預金口座から引き落とされた。',
        choices: [
          '(借) 支払家賃 500 / (貸) 普通預金 500',
          '(借) 普通預金 500 / (貸) 支払家賃 500',
          '(借) 支払家賃 500 / (貸) 現金 500',
          '(借) 支払家賃 600 / (貸) 普通預金 600',
        ],
        correct: 0,
        explanation: {
          concept: '家賃の支払い',
      ...
      {
        text: '【当座借越契約の利用】仕入先D社に対する買掛金 1,200円を小切手を振り出して支払った。なお、当座預金口座の残高は 1,000円であるが、当社は取引銀行と借越限度額 1,000円の当座借越契約を結んでいる。',
        choices: [
          '(借) 買掛金 1,200 / (貸) 当座預金 1,200',
          '(借) 買掛金 1,200 / (貸) 当座借越 1,200',
          '(借) 買掛金 1,200 / (貸) 現金 1,200',
          '(借) 買掛金 2,200 / (貸) 当座預金 2,200',
        ],
        correct: 0,
        explanation: {
          concept: '当座借越契約',
      ...
      },
      {
        ...
        choices: [
          ...
          '(借) 現金 5,000 / (貸) 当座預金 5,000',
          '(借) 現金 6,000 / (貸) 普通預金 6,000',
        ],
        correct: 0,
        explanation: {
          concept: '普通預金の引出',
      ...
      },
      {
        ...
        choices: [
          ...
          '(借) 仕入 4,000 / (貸) 普通預金 4,000',
          '(借) 商品 4,000 / (貸) 現金 4,000',
        ],
        correct: 0,
        explanation: {
          concept: '現金仕入',
      ...
      },
      {
        ...
        choices: [
          ...
          '(借) 普通預金 7,000 / (貸) 売上 7,000',
          '(借) 普通預金 8,000 / (貸) 売掛金 8,000',
        ],
        correct: 0,
        explanation: {
          concept: '売掛金の回収（入金）',
      ...
      },
      {
        ...
        choices: [
          ...
          '(借) 旅費交通費 1,000 / (貸) 仮払金 1,000',
          '(借) 旅費交通費 800 , 現金 300 / (貸) 仮払金 1,100',
        ],
        correct: 0,
        explanation: {
          concept: '仮払金の精算',
